/*
  ...
  Welcome to IVEE2 - A Powerful Programmable and Expandable RPN Calculator based on IVEE
  Version 1.0, (c) 2026 by emefff based on the code by deetee/zooxo. This software is covered by the 3-clause BSD license.
...
Kilo Code was used in developing this calculator, models used were mostly Codex-5.1, MiniMax M2.1 and Claude Sonnet 4.5.
...
Ivee2 is operated by 16 keys only it offers a wide range of functions
  ...
  - due to massive RAM and flash compared to ProMicro, IVEE2 is expandable in many ways.
  ...
  ____________________
    ...
    ~32000 steps/commands. To handle/edit/create user programs enter the program selector mode
    with PRG.
  ...
  ____________________
    ...
    To calculate with integer values in other numeric base enter the base and
...
Don't forget to include a reset button during development for flashing, sometimes nice!nanov2 likes to be reset twice, for reasons
unknown to me.
...
// This was necessary during development.
// If you have valid user programs and want to keep them, uncomment the next line.
// This is recommended during normal operation. 
...
// Comment during development, you're going to need it.
